...
- [Installation](#installation)
    ...
    - [Developer Installation (Local)](#developer-installation-local)
- [Usage](#usage)
    - [Drop an Anchor](#drop-an-anchor)
    - [Show the Anchor Overlay](#show-the-anchor-overlay)
    - [Clear an Anchor](#clear-an-anchor)
- [Settings](#settings)
    - [Reuse Existing Windows (Recommended)](#reuse-existing-windows-recommended)
    - [Switch to Moved Tab](#switch-to-moved-tab)
    - [Hyperlinks Only](#hyperlinks-only)
